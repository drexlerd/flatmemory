...
#ifndef FLATMEMORY_TYPES_UTILS_HPP_
#define FLATMEMORY_TYPES_UTILS_HPP_
...
/**
 * Compute alignmented needed to be added to cur_pos to obtain correct final_alignment for storing type T
