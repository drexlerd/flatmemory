...
TEST(FlatmemoryTests, TypesVectorDefaultConstructorTest)
{
    {
        // 1D
        auto builder = Builder<Vector<int16_t>>();
        builder.finish();
    ...
    {
        // 2D
        auto builder = Builder<Vector<Vector<int16_t>>>();
        builder.finish();
        EXPECT_EQ(builder.size(), 0);
        EXPECT_EQ(builder.get_buffer().size(), 4);
    }
...
TEST(FlatmemoryTests, TypesVectorConstructorTest)
{
    {
        // 1D
        auto builder = Builder<Vector<int16_t>>(3);
        builder.finish();
    ...
    {
        // 1D
        auto builder = Builder<Vector<int16_t, true>>(3);
        builder.finish();
        EXPECT_EQ(builder.size(), 3);
    ...
    {
        // 2D
        auto builder = Builder<Vector<Vector<int16_t>>>(3);
        builder.finish();
        EXPECT_EQ(builder.size(), 3);
    ...
    {
        // 2D
        auto builder = Builder<Vector<Vector<int16_t>, true>>(3);
        builder.finish();
        EXPECT_EQ(builder.size(), 3);
